...
<template>
  <div class="top-assists">
    <div class="text-2xl font-700 mb-4 uppercase">TOP ASSISTS</div>
    <div class="flex flex-col gap-4" v-if="players.length > 0">
      <div class="top-player flex w-full" v-for="(as, i) in players" :key="i">
...
<style lang="postcss">
.top-assists {
  @apply flex-1 flex flex-col gap-6 px-10 py-8;
}
</style>
